...
const resources = {
  uz: {
    t: {
      ...
      competitions: { title:'Musobaqalar', start:'Boshlash', fastMultiply:'Tez ko‘paytirish', numberMatch:'Raqam moslash poygasi', descFast:'1–9 sonlar bilan tezkor ko‘paytirish poygasi', descMatch:'Raqamni mos to‘plam bilan tez toping', levelEasy:'Oson', levelMedium:'O‘rta', time:'Vaqt', finished:'Musobaqa tugadi', finalScore:'Yakuniy ball: {{n}}', playAgain:'Qayta o‘ynash', finish:'Tugatish', matchPrompt:'Qaysi raqam mos?' },
      movement: { title:'Harakat', follow:'Birga bajaring!', didIt:'Bajarildi!', greatJobCoins:'Ajoyib! +{{n}} tanga',
        words:{ jump:'Sakra', clap:'Qarsak', stretch:"Cho'zil", twist:'Buril' }
      },
      ...
      stats: { title:'Statistika', top3:'Top 3', nominations:'Nominatsiyalar', coinHistory:'Tangalar tarixi', empty:'Tarix yo‘q', mostActive:'Eng faol', fastLearner:'Tez o‘rganuvchi', creative:'Ijodkor' },
  ...
  en: {
    t: {
      ...
      competitions: { title:'Competitions', start:'Start', fastMultiply:'Fast Multiplication', numberMatch:'Number Matching Race', descFast:'Speed run with 1–9 multiplication facts', descMatch:'Quickly match the number with the correct set', levelEasy:'Easy', levelMedium:'Medium', time:'Time', finished:'Competition finished', finalScore:'Final score: {{n}}', playAgain:'Play again', finish:'Finish', matchPrompt:'Which number matches?' },
      movement: { title:'Movement', follow:'Follow along!', didIt:'I did it!', greatJobCoins:'Great job! +{{n}} coins',
        words:{ jump:'Jump', clap:'Clap', stretch:'Stretch', twist:'Twist' }
      },
      ...
      stats: { title:'Stats', top3:'Top 3', nominations:'Nominations', coinHistory:'Coin History', empty:'No history', mostActive:'Most Active', fastLearner:'Fast Learner', creative:'Creative Mind' },
  ...
  ru: {
    t: {
      ...
      competitions: { title:'Соревнования', start:'Старт', fastMultiply:'Быстрое умножение', numberMatch:'Гонка по сопоставлению чисел', descFast:'Скоростные примеры на умножение 1–9', descMatch:'Быстро сопоставляй число с правильным набором', levelEasy:'Легко', levelMedium:'Средне', time:'Время', finished:'Соревнование завершено', finalScore:'Итоговый счёт: {{n}}', playAgain:'Играть ещё', finish:'Завершить', matchPrompt:'Какое число подходит?' },
      movement: { title:'Движение', follow:'Повторяйте за нами!', didIt:'Готово!', greatJobCoins:'Здорово! +{{n}} монет',
        words:{ jump:'Прыгай', clap:'Хлопай', stretch:'Тянись', twist:'Повернись' }
      },
      ...
      stats: { title:'Статистика', top3:'Топ 3', nominations:'Номинации', coinHistory:'История монет', empty:'Нет записей', mostActive:'Самый активный', fastLearner:'Быстро обучается', creative:'Творческий' },
